...
public class Utils {
	...
	public static String formatMessage(String text, String killer, String victim, String kill_number, String time,
			String date) {
		String newtext = text.replace("%killer%", killer).replace("%victim%", victim)
				.replace("%kill_number%", kill_number).replace("%timenow%", time).replace("%datenow%", date);

		return Color(newtext);
	}

	public static String formatMessage(String text) {
		String newtext = text.replace("%timenow%", formattedTimeNow()).replace("%datenow%", formattedDateNow());

		return Color(newtext);

	}

	public static String formatMessage(String text, String killer, String victim) {
		String newtext = text.replace("%killer%", killer).replace("%victim%", victim)
				.replace("%timenow%", formattedTimeNow()).replace("%datenow%", formattedDateNow());
